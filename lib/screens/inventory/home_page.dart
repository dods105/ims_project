          ...
          Padding(
            ...
            child: Row(
              children: const [
                ...
                Expanded(flex: 3, child: Text('STOCKS', style: TextStyle(fontWeight: FontWeight.bold))),
                            ...
                            Expanded(
                              ...
                              child: Column(
                                ...
                                children: const [
                                  ...
                                  Text('---', style: TextStyle(color: Colors.white70, fontSize: 10)),
                                ],
                              )
                            ),
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  const Text("Digital Receipt", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  IconButton(
              ...
              Center(
                child: Column(
                  children: [
                    ...
                    const Text("Pedro's Store", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                    const Text("Official Receipt", style: TextStyle(color: Colors.grey, fontSize: 12)),
                  ],
                ),
              ),
              const SizedBox(height: 20),
              ...
              Row(
                ...
                children: const [
                  ...
                  Text("₱225.00", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blue)),
                ],
              ),
              
              const Spacer(),
              const Center(child: Text("Thank you for your purchase!", style: TextStyle(color: Colors.grey, fontSize: 12))),
