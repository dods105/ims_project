...
class _AddingSectionPageState extends ConsumerState<AddingSectionPage> {
  ...
  child: ElevatedButton(
    style: ElevatedButton.styleFrom(
      elevation: 0, // remove default shadow if you want flat look
      backgroundColor: const Color.from(alpha: 0, red: 0, green: 0, blue: 0),
      foregroundColor: const Color.fromARGB(255, 38, 15, 144),
      side: BorderSide(color:  Color.fromARGB(255, 38, 15, 144)), // border
    ...
    child: Column(
      ...
      children: [
        ...
        Text(
          'Photo',
          style: TextStyle(
            color: const Color.fromARGB(255, 38, 15, 137),
          ),
        ),
      ],
    ),
